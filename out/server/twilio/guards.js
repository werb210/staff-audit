...
export const isTestNumber = (p) => ["+15005550000", "+15005550006", "+15005550008", "+15005550009"].includes(p);
export function maskPhone(phone) {
    return phone.replace(/^\+?1?(\d{3})(\d{3})(\d{4})$/, "+1 $1-***-$3");
}
export function enforceProductionSecurity(phone, environment = "production") {
