...
router.get("/api/marketing/ads/campaigns", async (req, res) => {
    try {
...
router.post("/api/marketing/ads/campaigns", async (req, res) => {
    try {
...
router.patch("/api/marketing/ads/campaigns/:id", async (req, res) => {
    try {
        const { id } = req.params;
