...
router.get("/api/marketing/messaging/sequences", async (req, res) => {
    try {
...
// Get sequence steps
router.get("/api/marketing/messaging/sequences/:id/steps", async (req, res) => {
    try {
        const { id } = req.params;
...
// Create new sequence
router.post("/api/marketing/messaging/sequences", async (req, res) => {
    try {
