...
router.get("/marketing/google-ads/campaigns", async (req, res) => {
    try {
...
router.post("/marketing/google-ads/campaigns", async (req, res) => {
    try {
...
router.get("/marketing/linkedin/campaigns", async (req, res) => {
    try {
...
router.post("/marketing/linkedin/campaigns", async (req, res) => {
    try {
        const campaignData = req.body;
