...
router.post('/oauth/callback', async (req, res) => {
    try {
        const { userId, provider, accessToken, refreshToken, expiresIn, scope } = req.body;
        ...
        // Save the token
        const savedToken = await tokenService.saveToken(userId, provider, accessToken, refreshToken, expiresAt, scope);
        res.json({
            success: true,
