 ...
 */
router.post('/call-action', async (req, res) => async (req, res) => {
 ...
 */
router.get('/call-history', async (req, res) => async (req, res) => {
 ...
 */
router.patch('/missed-calls/:id/handle', async (req, res) => async (req, res) => {
 ...
 */
router.get('/call-status', async (req, res) => async (req, res) => {
    try {
