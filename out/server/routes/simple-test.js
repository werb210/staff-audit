...
router.post('/public-applications', async (req, res) => {
    try {
        ...
        const { business_name = 'Test Company', contact_email = 'test@example.com', contact_phone = '555-0123', business_type = 'llc', requested_amount = 25000, loan_purpose = 'equipment' } = req.body;
