 ...
 */
export function mountRefreshApplicationData(app) {
    // Simple status endpoint for checking refresh functionality
    app.get('/api/applications/refresh/status', async (req, res) => {
        try {
    ...
    app.post('/api/applications/refresh-all', async (req, res) => {
        try {
            const { pool } = await import('../db');
    ...
    app.post('/api/applications/:id/refresh', async (req, res) => {
        try {
            const { pool } = await import('../db');
