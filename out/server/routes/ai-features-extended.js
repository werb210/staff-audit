 ...
 */
router.post('/draft-lender-email', async (req, res) => {
    try {
 ...
 */
router.get('/summary-history/:applicationId', async (req, res) => {
    try {
 ...
 */
router.post('/extract-escalation', async (req, res) => {
    try {
 ...
 */
router.post('/contact-tags', async (req, res) => {
    try {
