...
r.post("/marketing/roi/upload-csv", upload.single('csvFile'), async (req, res) => {
    if (!req.file) {
...
r.get("/marketing/roi/csv-template", (req, res) => {
...
r.get("/marketing/roi/import-history", async (req, res) => {
    try {
