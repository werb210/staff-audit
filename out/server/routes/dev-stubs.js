...
// calendar & tasks
devStubs.get("/calendar/events", (req, res) => res.json({ ok: true, events: [] }));
devStubs.get("/calendar/events-old", (req, res) => res.json({ ok: true, events: [] }));
...
// marketing
devStubs.get("/marketing/connected-accounts", (_req, res) => res.json({ ok: true, accounts: [] }));
