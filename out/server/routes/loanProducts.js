...
router.get('/loan-products/required-documents/:category', async (req, res) => {
    try {
        ...
        const searchCountry = countryMapping[headquarters] || headquarters;
        ...
        const matchingProducts = await db
            ...
            .from(lenderProducts)
            .where(and(categoryMatch, eq(lenderProducts.country, searchCountry), lte(lenderProducts.minAmount, fundingAmountNum.toString()), gte(lenderProducts.maxAmount, fundingAmountNum.toString())));
