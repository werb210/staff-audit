...
r.get('/api/voice/token', (req, res) => {
    const silo = req.query.silo || "BF";
    ...
    try {
        const token = new AccessToken(accountSid, apiKeySid, apiKeySecret, { identity: `staff:${req.ip || 'anonymous'}` });
