...
router.get('/ms/callback', (req, res) => {
...
router.delete('/ms/disconnect', (req, res) => {
    res.json({
        ok: true,
...
router.get('/li/callback', (req, res) => {
    const { code, state } = req.query;
    if (!code) {
        return res.status(400).json({
            ok: false,
...
router.get('/tw/callback', (req, res) => {
    const { code, state } = req.query;
    if (!code) {
        return res.status(400).json({
            ok: false,
...
router.get('/ga/callback', (req, res) => {
    const { code, state } = req.query;
    if (!code) {
        return res.status(400).json({
            ok: false,
...
router.post('/sg/connect', (req, res) => {
...
router.delete('/sg/disconnect', (req, res) => {
    res.json({
        ok: true,
...
router.post('/tw/connect', (req, res) => {
...
router.delete('/tw/disconnect', (req, res) => {
    res.json({
        ok: true,
...
router.post('/sync/:integration_id', (req, res) => {
...
router.get('/:integration_id/analytics', (req, res) => {
    const { integration_id } = req.params;
