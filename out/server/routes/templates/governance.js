...
router.get("/sets/:setId/versions", async (req, res) => {
...
router.post("/sets/:setId/versions", async (req, res) => {
    const { setId } = req.params;
...
/* Reject template */
router.post("/versions/:versionId/reject", async (req, res) => {
    const { versionId } = req.params;
    const { reason } = req.body || {};
...
/* Publish template */
router.post("/versions/:versionId/publish", async (req, res) => {
    const { versionId } = req.params;
...
router.get("/published/:setKey/:channel", async (req, res) => {
