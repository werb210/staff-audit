...
router.get('/lenders/:lenderName/credentials', async (req, res) => {
    try {
...
router.post('/lenders/:lenderName/credentials', async (req, res) => {
    try {
        const { lenderName } = req.params;
...
router.delete('/lenders/:lenderName/credentials', async (req, res) => {
    try {
        const { lenderName } = req.params;
        if (!lenderName) {
            return res.status(400).json({
...
router.delete('/lenders/:lenderName/delete', async (req, res) => {
    try {
        const { lenderName } = req.params;
        if (!lenderName) {
            return res.status(400).json({
