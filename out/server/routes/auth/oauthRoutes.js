...
router.get('/microsoft/callback', async (req, res) => {
    try {
        ...
        // Save tokens
        await tokenService.saveToken(userId, 'microsoft', tokens.access_token, tokens.refresh_token, expiresAt, tokens.scope);
...
router.get('/google/callback', async (req, res) => {
    try {
        ...
        // Save tokens
        await tokenService.saveToken(userId, 'google', tokens.access_token, tokens.refresh_token, expiresAt, tokens.scope);
...
router.get('/linkedin/callback', async (req, res) => {
    try {
        ...
        const expiresAt = tokens.expires_in ? new Date(Date.now() + tokens.expires_in * 1000) : undefined;
        // Save tokens
        await tokenService.saveToken(userId, 'linkedin', tokens.access_token, tokens.refresh_token, expiresAt, tokens.scope);
