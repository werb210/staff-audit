...
r.get("/marketing/sequences/:id/enrollments", async (req, res) => {
...
r.post("/marketing/audiences", async (req, res) => {
...
r.post("/marketing/experiments", async (req, res) => {
...
r.post("/marketing/short-links", async (req, res) => {
...
r.get("/marketing/short-links/:code/stats", async (req, res) => {
