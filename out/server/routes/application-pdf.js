...
function generateApplicationSummaryHTML(application, documents, ocrData, lenderMatches) {
...
r.post("/application/:id/generate-pdf", async (req, res) => {
    const { id } = req.params;
    try {
        ...
        const htmlContent = generateApplicationSummaryHTML(applicationData, applicationDocuments, ocrData, lenderMatches);
        // Generate PDF
...
r.post("/applications/generate-all-pdfs", async (req, res) => {
    try {
    ...
    `);
        ...
        `, [app.id]);
                ...
                // Generate HTML content
                const htmlContent = generateApplicationSummaryHTML(app, applicationDocuments.rows, ocrData, []);
                // Generate PDF
...
r.get("/test-pdf-generator", async (req, res) => {
    try {
