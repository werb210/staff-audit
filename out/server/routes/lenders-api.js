...
router.get("/lenders", async (req, res) => {
    try {
        ...
        const lendersWithProducts = await db
            ...
            .groupBy(lenders.id, lenders.name, lenders.address, lenders.mainPhone, lenders.mainContactFirst, lenders.mainContactLast, lenders.mainContactMobile, lenders.mainContactEmail, lenders.url, lenders.description)
...
router.put("/lenders/:id", async (req, res) => {
    try {
        ...
        const cleanData = Object.fromEntries(Object.entries(sanitizedData).filter(([_, value]) => value !== undefined));
...
router.post("/lender-products", async (req, res) => {
    try {
...
router.put("/lender-products/:id", async (req, res) => {
    try {
...
router.delete("/lender-products/:id", async (req, res) => {
    try {
...
router.post("/lenders/:lenderId/products", async (req, res) => {
    try {
...
router.put("/lenders/:lenderId/products/:productId", async (req, res) => {
    try {
...
router.get("/lenders/:lenderId/products/:productId", async (req, res) => {
    try {
