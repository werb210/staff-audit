...
router.get('/sms', async (req, res) => {
    ...
    `);
        const threadsData = threads.rows.map((thread) => ({
            id: thread.thread_id,
...
router.get('/sms/:threadId', async (req, res) => {
    try {
...
// TwiML Routes
router.post('/voice/twiml/voicemail', (req, res) => {
    const twiml = `
    <Response>
...
router.post('/webhooks/call-events', async (req, res) => {
    try {
