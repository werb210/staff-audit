    ...
    return function (req, res, next) {
        ...
        res.json = (body) => {
            try {
                ...
                const tagV1Product = (p) => prov.attach(p, {
                    id: prov.db(),
                    lender_id: prov.db(),
                ...
                const tagLender = (l) => prov.attach(l, {
                    id: prov.db(),
                    name: prov.db(),
                ...
                const tagApplication = (a) => prov.attach(a, {
                ...
                // validate-intake (echo product + intake)
                    ...
                    if (body.product)
                        body.product = tagV1Product(body.product);
                    if (body.intake)
                        body.intake = tagApplication(body.intake);
                    if (body.application)
                        body.application = tagApplication(body.application);
                    body._diag = { counts: prov.summarize([body.product, body.intake, body.application].filter(Boolean)) };
                    augmented = body;
                }
