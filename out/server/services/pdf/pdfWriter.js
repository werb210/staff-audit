...
export class PDFWriterService {
    ...
    async generatePDFFromMarkdown(markdown, options = {}) {
        try {
    ...
    async renderContentToPDF(pdfDoc, content, font, boldFont, options, margins) {
        ...
        for (const element of content) {
            ...
            // Render element
            currentY = this.renderElement(currentPage, element, font, boldFont, margins.left, currentY, width - margins.left - margins.right);
        }
    ...
    // Add header to page
    addHeader(page, headerText, font, margins, pageWidth) {
    ...
    // Add footer to page
    addFooter(page, footerText, font, margins, pageHeight) {
    ...
    renderElement(page, element, font, boldFont, x, y, maxWidth) {
        switch (element.type) {
            case 'heading':
