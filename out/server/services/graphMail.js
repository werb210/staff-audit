...
export async function graphSendMail(accessToken, to, subject, html) {
...
export async function graphCreateTask(accessToken, title, bodyHtml) {
    ...
    if (!listId)
        throw new Error("No To Do list available");
