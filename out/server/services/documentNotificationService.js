...
export class DocumentNotificationService {
    ...
    static async startMonitoring(callback) {
        ...
        global.documentMonitorInterval = monitorInterval;
    }
    /**
     * Check for new document submissions since last check
     */
    static async checkForNewSubmissions() {
        try {
    ...
    static stopMonitoring() {
        if (global.documentMonitorInterval) {
            clearInterval(global.documentMonitorInterval);
            delete global.documentMonitorInterval;
        }
     ...
     */
    static formatSubmissionNotification(submission) {
 ...
 */
export function documentSubmissionCallback(submission) {
