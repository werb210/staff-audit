...
export class AutoSmsService {
     ...
     */
    static async checkAndSendSmsForNewApplication(applicationId) {
        try {
            ...
            console.log(`📋 [AUTO-SMS-SERVICE] Application found: ${application.formData?.step3?.businessName || 'Unknown'}`);
     ...
     */
    static async triggerPipelineEvaluationForStageMismatch(applicationId) {
        try {
     ...
     */
    static async processNewApplication(applicationId) {
        try {
