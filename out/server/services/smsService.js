 ...
 */
export async function sendSmsTemplate(templateType, phoneNumber, templateData) {
    try {
 ...
 */
export async function sendSmsForApplication(applicationId, templateType, customData) {
