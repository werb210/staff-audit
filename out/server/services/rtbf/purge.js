 ...
 */
export async function purgeContactData(contactId) {
    console.log(`[RTBF] Starting data purge for contact ${contactId}`);
    const results = { tables: {}, anonymized: {}, errors: [] };
    try {
      ...
      `);
            ...
            results.errors.push(`comm_messages: ${error.message}`);
        }
      ...
      `);
            ...
            results.errors.push(`applications: ${error.message}`);
        }
      ...
      `);
            ...
            results.errors.push(`audit_log: ${error.message}`);
        }
 ...
 */
export async function purgeApplicationData(applicationId) {
    ...
    try {
      ...
      `);
            ...
            results.errors.push(`lender_activity: ${error.message}`);
        }
      ...
      `);
            ...
            results.errors.push(`decision_traces: ${error.message}`);
        }
      ...
      `);
            ...
            results.errors.push(`application_anonymization: ${error.message}`);
        }
