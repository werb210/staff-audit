...
const DOCUMENT_REQUIREMENTS_MAP = {
...
export class DocumentRequirementsService {
     ...
     */
    static getRequirement(requirementId) {
     ...
     */
    static mapRequirementsToExpectedDocuments(applicationId, requirementIds) {
     ...
     */
    static findRequirementByCategory(category) {
        return Object.values(DOCUMENT_REQUIREMENTS_MAP)
