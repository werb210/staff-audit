...
export class PipelineAutomationService {
     ...
     */
    static async checkDocumentCompletionStatus(applicationId) {
        try {
     ...
     */
    static async moveToLenderMatching(applicationId) {
        try {
     ...
     */
    static async notifyClientOfRejection(applicationId) {
        try {
     ...
     */
    static async notifyStaffOfProgression(applicationId, newStage) {
        try {
     ...
     */
    static async notifyDocumentUpload(applicationId, documentType, fileName) {
        try {
