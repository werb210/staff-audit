 ...
 */
export async function generateAICreditSummary(applicationId, templateId) {
 ...
 */
export async function saveDraftSummary(summaryId, content, userId) {
    try {
 ...
 */
export async function submitFinalSummary(summaryId, finalContent, userId) {
    ...
    try {
        ...
        if (existingSummary.originalSummary !== finalContent) {
            await recordTrainingData(existingSummary.applicationId, summaryId, existingSummary.originalSummary || '', finalContent, userId);
        }
 ...
 */
async function generateSummaryWithAI(appData, template) {
    if (!openaiClient) {
 ...
 */
async function recordTrainingData(applicationId, summaryId, originalSummary, finalSummary, userId) {
    try {
        // Calculate diff
 ...
 */
function calculateEditIntensity(original, final) {
 ...
 */
async function generatePDFFromSummary(content, summary) {
