...
export async function generateSignedApplicationPdf(applicationId) {
    try {
        ...
        const applicationQuery = await db.execute(`SELECT a.*, b.business_name, b.legal_business_name, b.business_type,
