...
export async function queueAIJob(data) {
...
export async function getJobStatus(requestId) {
...
async function updateJobStatus(requestId, status, result, error) {
...
async function processDocumentScan(input) {
...
async function processCreditSummary(input) {
