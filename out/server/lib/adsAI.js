...
export async function aiExplainChange(ctx) {
...
export async function aiWriteAds(input) {
...
export async function aiAssetGaps(assets) {
...
export async function aiSmartNegatives(data) {
