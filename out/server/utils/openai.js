...
export function buildCreditSummaryPrompt(data) {
    return `
...
export function buildNextStepPrompt(data) {
    return `
...
export function buildDocumentMatchPrompt(documents, requirements) {
    return `
...
export function buildDocumentSummaryPrompt(documents) {
    return `
...
export async function callOpenAI(prompt, maxTokens = 1500) {
