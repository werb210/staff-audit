 ...
 */
export function validateDocuments(appDocs, requiredTypes) {
 ...
 */
export function hasAllRequiredDocuments(appDocs, requiredTypes) {
 ...
 */
export function getDocumentValidationStatus(appDocs, requiredTypes) {
    const missing = validateDocuments(appDocs, requiredTypes);
    const uploaded = appDocs.map(d => d.documentType);
    return {
