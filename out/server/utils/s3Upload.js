...
if (!bucket)
    throw new Error("❌ S3_BUCKET env variable missing");
...
export async function uploadToS3(applicationId, file) {
...
export async function uploadDocumentToS3(applicationId, buffer, options) {
