...
export function DialerFab() {
  const onClick = async () => {
    ...
    loadingToast.style.cssText = 'position: fixed; top: 20px; right: 20px; background: #3b82f6; color: white; padding: 12px; border-radius: 8px; z-index: 1000;';
  ...
  return (
    <div style={{ position: "fixed", right: 24, bottom: 24 }}>
      <button
        ...
        style={{
          width: 56, height: 56,
          borderRadius: 28, border: "none", cursor: "pointer", boxShadow: "0 8px 20px rgba(0,0,0,.2)",
          backgroundColor: "#10b981", color: "white", fontSize: "24px"
        }}
