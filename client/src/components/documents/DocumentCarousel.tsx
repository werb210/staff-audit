...
export function DocumentCarousel({ applicationId }: DocumentCarouselProps) {
    ...
    queryFn: async () => {
      try {
        const result = await api(
          `/api/pipeline/cards/${applicationId}/documents`,
        );
  ...
  const { mutate: updateDocumentStatus } = useMutation({
    mutationFn: async ({
      ...
      return await api(
        `/api/pipeline/cards/${applicationId}/docs/${docId}/${action}`,
        {
          method: "POST",
        },
      );
                ...
                >
                  <div className="w-32 h-40 bg-white border-2 border-gray-200 rounded-lg overflow-hidden shadow-sm">
                    <div className="h-32 bg-gray-50 flex items-center justify-center relative">
                      ...
                      <div
                        className={`absolute top-2 right-2 flex items-center gap-1 px-2 py-1 text-xs rounded-full border ${getStatusColor(doc.status)}`}
                      >
            ...
            {currentDocument && (
              <div className="bg-gray-50 border rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div
                    className={`px-3 py-1 text-sm rounded-full border ${getStatusColor(currentDocument.status)}`}
                  >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>Download document file</TooltipContent>
                    </Tooltip>
