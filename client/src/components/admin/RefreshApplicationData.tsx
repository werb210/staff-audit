  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Refresh all application cards to populate all available fields and ensure documents are visible
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">
              Updates cards with business details, contact info, and document status
            </p>
          </div>
          <Button 
        ...
        {lastRefresh && (
          <div className="text-sm text-gray-600 border-t pt-4">
            <p><strong>Last refreshed:</strong> {lastRefresh}</p>
          </div>
        )}
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t">
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge variant={stats.withDocuments > 0 ? "default" : "secondary"}>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Badge variant={stats.readyForLenders > 0 ? "default" : "secondary"}>
        ...
        <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <h4 className="font-medium text-blue-900 mb-2">Enhanced Card Information</h4>
          <p className="text-sm text-blue-800 mb-2">
            After refresh, application cards will display:
          </p>
          <ul className="text-sm text-blue-700 space-y-1">
            <li>• <strong>Business Details:</strong> Industry, type, revenue, employees, years in business</li>
            <li>• <strong>Contact Information:</strong> Email, phone, address, website</li>
            <li>• <strong>Financial Data:</strong> Loan amount, use of funds, annual revenue</li>
            <li>• <strong>Document Status:</strong> Count, verification status, missing documents</li>
            <li>• <strong>Recent Uploads:</strong> Preview of latest documents with status indicators</li>
          </ul>
        </div>

        {/* Document Display Info */}
        <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
          <h4 className="font-medium text-green-900 mb-2">Document Visibility</h4>
          ...
          <ul className="text-sm text-green-700 space-y-1 mt-2">
            ...
            <li>• ✅ Shown with verification status (verified/pending/rejected)</li>
