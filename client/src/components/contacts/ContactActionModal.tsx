...
export function ContactActionModal({
  ...
  const target = useMemo(
    () => document.getElementById("contact-detail-panel") ?? document.body,
    [],
  );
  ...
  function openDialer() {
    ...
    window.dispatchEvent(
      new CustomEvent("dialer:open", { detail: { to: contact.phone, silo } }),
    );
    onClose();
  }
  ...
  async function createApp() {
    ...
    if (r.ok) {
      ...
      window.dispatchEvent(
        new CustomEvent("pipeline:open-app", { detail: { id } }),
      );
    }
  }
          ...
          <div className="space-y-4">
            <p className="text-sm text-gray-600">
              ...
              {contact.phone ? (
                <>
                  {" "}
                  at <span className="font-mono">{contact.phone}</span>
                </>
              ) : null}
            </p>
            <button
          ...
          : kind === "schedule"
            ...
            : kind === "upload"
              ...
              : Card(
                  <div className="space-y-4">
                    <p className="text-sm text-gray-600">
                      Create a new application linked to{" "}
