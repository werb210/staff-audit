// client/src/lib/normalizeApplication.ts
export type ApiApp = Record<string, any>;

export function normalizeApplication(a: ApiApp) {
  return {
    // Applicant
    ...
    registration:
      a.registration_no ?? a.registrationNumber ?? a.registration ?? "",
