...
async function getLenderProductsCount(): Promise<number> {
  try {
...
async function getSampleLenderProduct(): Promise<any> {
  try {
    const result = await db.execute(`
...
async function createSchemaSnapshot(): Promise<SchemaSnapshot> {
...
async function validateSchema(snapshot: SchemaSnapshot): Promise<boolean> {
