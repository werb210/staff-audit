...
export async function attachPgPerRequest(req: Request, res: Response, next: NextFunction) {
  ...
  try {
    ...
    const rawTenantId = (req as any).tenantId || "bf";
    let tenantId: string;
    ...
    (req as any).pgQuery = async (text: string, params: any[] = []) => {
