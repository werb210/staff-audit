...
CREATE TABLE IF NOT EXISTS staff_applications(
  ...
  business_file_name varchar(255),
...
-- Seed admin user
INSERT INTO staff_users (email, phone, role, file_name) 
VALUES ('todd.w@boreal.financial', '+15878881837', 'admin', 'Todd Werboweski')
ON CONFLICT (email) DO NOTHING;

-- Add some sample data
INSERT INTO staff_contacts (full_file_name, email, phone, tags) 
VALUES 
...
INSERT INTO staff_lender_products (lender, file_name, country, category, min_amount, max_amount, min_rate, max_rate, min_term, max_term, notes)
VALUES 
