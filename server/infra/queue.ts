...
export function makeWorker(name: string, processor: Parameters<typeof Worker>[1]) {
...
export type EnqueueOpts = JobsOptions & { correlationId?: string; };
export async function enqueue<T=any>(q: Queue, name: string, data: T, opts: EnqueueOpts = {}) {
