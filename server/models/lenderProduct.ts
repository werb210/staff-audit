...
export const countryOptions = ['United States', 'Canada'] as const;

// Rate type enum
export const rateTypeOptions = ['Fixed', 'Floating'] as const;

// Rate frequency enum
export const rateFrequencyOptions = ['Monthly', 'Annually'] as const;

// Canonical interface matching all database columns exactly
export interface LenderProduct {
  ...
  country: string | null;
  minAvgMonthlyRevenue: number | null;
  minCreditScore: number | null;
  requiredDocuments: string[] | null;
}

// Insert type (omits auto-generated fields)
export interface InsertLenderProduct {
  lenderName: string;
  productName: string;
...
// Type exports
export type LenderProductSelect = typeof lenderProducts.$inferSelect;
export type LenderProductInsert = typeof lenderProducts.$inferInsert;