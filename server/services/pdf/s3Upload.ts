...
export async function uploadPDFToS3(objectKey: string, pdfBuffer: Uint8Array): Promise<string> {
  try {
...
export async function getPresignedDownloadUrl(objectKey: string, expiresIn: number = 3600): Promise<string> {
  try {
