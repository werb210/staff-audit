export type Canonical =
  | 'product_id' | 'country' | 'product_category' | 'amount_requested'
  | 'years_in_business' | 'months_in_business' | 'annual_revenue' | 'monthly_revenue'
  | 'business_legal_name' | 'business_trade_name' | 'industry'
  | 'contact_name' | 'contact_email' | 'contact_phone'
  | 'business_street' | 'business_city' | 'business_state' | 'business_postal_code' | 'business_website'
  | 'applicant_first_name' | 'applicant_last_name'
  | 'documents';

export const alias: Record<Canonical, string[]> = {
  // product / amounts
