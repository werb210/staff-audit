 ...
 */
router.get('/sms/contacts', async (req: any, res: any) => {
  try {
 ...
 */
router.get('/sms/messages/:contactId', async (req: any, res: any) => {
  try {
 ...
 */
router.get('/calls/contacts', async (req: any, res: any) => {
  try {
 ...
 */
router.get('/calls/logs/:contactId', async (req: any, res: any) => {
  try {
    const { contactId } = req.params;
 ...
 * Get email threads
 */
router.get('/email/threads', async (req: any, res: any) => {
  try {
 ...
 */
router.get('/email/messages/:threadId', async (req: any, res: any) => {
  try {
