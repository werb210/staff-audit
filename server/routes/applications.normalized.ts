...
router.get('/normalized', requireAuth, async (req: any, res: any) => {
  try {
...
router.get('/normalized/:id', requireAuth, async (req: any, res: any) => {
  try {
    const enhancedQuery = `
      SELECT 
...
router.get('/board/normalized', requireAuth, async (req: any, res: any) => {
  try {
