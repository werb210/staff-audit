...
router.get('/lender-users', async (req: any, res: any) => {
  try {
    const result = await db.query(`
      SELECT 
        lu.id,
...
router.post('/lender-users', async (req: any, res: any) => {
  try {
...
router.patch('/lender-users/:id', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
// Delete lender user
router.delete('/lender-users/:id', async (req: any, res: any) => {
  try {
    const { id } = req.params;
