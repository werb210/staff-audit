...
r.post("/:id/variants", async (req: any, res) => {
  try {
...
r.get("/:id/assign/:userId", async (req: any, res) => {
  try {
...
// Record conversion
r.post("/:id/convert/:userId", async (req: any, res) => {
  try {
    const { id: experimentId, userId } = req.params;
...
r.get("/:id/results", async (req: any, res) => {
  try {
    const experimentId = req.params.id;
