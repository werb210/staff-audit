...
router.get("/api/marketing/email/templates", async (req: any, res: any) => {
  try {
...
// Send test email
router.post("/api/marketing/email/test-send", async (req: any, res: any) => {
  try {
...
router.post("/api/marketing/email/templates", async (req: any, res: any) => {
  try {
