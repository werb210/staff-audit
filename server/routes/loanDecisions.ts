 ...
 */
router.post('/:applicationId/approve', async (req: any, res: any) => {
  try {
 ...
 */
router.post('/:applicationId/reject', async (req: any, res: any) => {
  try {
    const { applicationId } = req.params;
 ...
 */
router.post('/:applicationId/funded', async (req: any, res: any) => {
  try {
    const { applicationId } = req.params;
 ...
 */
router.post('/:applicationId/custom', async (req: any, res: any) => {
  try {
    const { applicationId } = req.params;
