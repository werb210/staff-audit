...
import ws from 'ws';
import { IndustryBenchmarkingService, ApplicantMetrics } from '../industry-benchmarking-service';
...
router.post('/analyze/:applicationId', simpleAuth, async (req: any, res: any) => {
  ...
  try {
    ...
    const applicantMetrics: ApplicantMetrics = {
    ...
    const benchmarkResult = await benchmarkingService.benchmarkApplicant(
      applicantMetrics,
 ...
 */
router.get('/results/:applicationId', simpleAuth, async (req: any, res: any) => {
  try {
    const applicationId = req.params.applicationId;
 ...
 */
router.get('/industry/:industry', simpleAuth, async (req: any, res: any) => {
  try {
 ...
 */
router.get('/industries', simpleAuth, async (req: any, res: any) => {
  try {
 ...
 */
router.post('/bulk-analyze', simpleAuth, async (req: any, res: any) => {
  try {
 ...
 */
router.post('/generate-report/:applicationId', simpleAuth, async (req: any, res: any) => {
  try {
    const applicationId = req.params.applicationId;
