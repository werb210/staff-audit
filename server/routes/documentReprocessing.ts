...
router.post("/:id/reprocess", async (req: any, res: any) => {
  try {
...
router.post("/:id/reanalyze-banking", async (req: any, res: any) => {
  try {
    const documentId = req.params.id;
