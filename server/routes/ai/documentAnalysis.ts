...
router.post('/documents/:id/insights', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/applications/:id/discrepancies', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/documents/:id/banking-analysis', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/documents/batch-insights', async (req: any, res: any) => {
  try {
...
router.post('/documents/batch-banking', async (req: any, res: any) => {
  try {
    const { documentIds } = req.body;
...
router.post('/applications/:id/aggregate-fields', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/applications/:id/document-summary', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/applications/:id/financial-projections', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/applications/:id/credit-summary', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/applications/:id/risk-score', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/applications/:id/field-conflicts', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/documents/:id/balance-trends', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/documents/:id/nsf-trends', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.get('/required-fields', async (req: any, res: any) => {
  try {
