...
router.get('/applications/:id/risk-score', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/documents/:id/auto-tag', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/applications/:id/process', async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
router.post('/batch-process', async (req: any, res: any) => {
  try {
