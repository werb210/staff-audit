...
// Get current tenant
router.get("/current", requireAnyRole(["admin","manager","agent","marketing","lender","referrer"]), (req: any, res) => {
...
router.post("/switch", requireAnyRole(["admin","manager"]), (req: any, res) => {
...
router.get("/config", requireAnyRole(["admin","manager","agent","marketing","lender","referrer"]), (req: any, res) => {
