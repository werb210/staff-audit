...
router.patch("/users/:id", async (req: any, res: any) => {
  try {
    ...
    if (req.body.accessBf !== undefined) updateData.accessBf = req.body.accessBf;
    if (req.body.accessSlf !== undefined) updateData.accessSlf = req.body.accessSlf;
...
router.delete("/users/:id/hard-delete", async (req: any, res: any) => {
  try {
    const { id } = req.params;
