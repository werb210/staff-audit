...
router.get('/google-ads/campaigns', async (req: any, res: any) => {
  try {
...
router.post('/google-ads/campaigns', async (req: any, res: any) => {
  try {
...
router.patch('/google-ads/campaigns/:id/status', async (req: any, res: any) => {
  try {
    const { id } = req.params;
