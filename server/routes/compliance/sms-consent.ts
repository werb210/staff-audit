...
// Record SMS consent
r.post("/record", async (req: any, res) => {
  try {
...
r.get("/status/:phoneNumber", async (req: any, res) => {
  try {
...
r.post("/keyword", async (req: any, res) => {
  try {
...
r.get("/quiet-hours/:contactId", async (req: any, res) => {
  try {
