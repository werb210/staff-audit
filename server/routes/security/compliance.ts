...
/* Secrets Management */
router.get("/secrets", async (req: any, res) => {
...
router.post("/secrets/:name/rotate", async (req: any, res) => {
...
/* Audit Export */
router.post("/audit/export", async (req: any, res) => {
...
router.post("/documents/:id/av-check", async (req: any, res) => {
  const { id } = req.params;
