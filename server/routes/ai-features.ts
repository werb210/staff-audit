...
router.post('/ai/credit-summary/generate', async (req: any, res: any) => {
  try {
...
// AI Risk Scoring
router.post('/ai/risk-score', async (req: any, res: any) => {
  try {
...
router.post('/ai/template/generate', async (req: any, res: any) => {
  try {
