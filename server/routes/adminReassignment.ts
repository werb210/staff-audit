...
router.post('/documents/reassign/:documentId', requireAdmin, async (req: any, res) => {
  try {
...
router.get('/documents/history/:applicationId', requireAdmin, async (req: any, res) => {
  try {
...
router.post('/documents/reassign/test', async (req: any, res) => {
