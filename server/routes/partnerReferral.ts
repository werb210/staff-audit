 ...
 */
router.post('/enrich-contact', async (req: any, res: any) => async (req: any, res: any) => {
 ...
 */
router.get('/lead-sources', async (req: any, res: any) => {
 ...
 */
router.get('/pipeline-view', async (req: any, res: any) => async (req: any, res: any) => {
 ...
 */
function determinePriority(contact: any): number {
