...
import { documents, applications, ocrResults } from '../../shared/schema.ts';
...
router.post('/process-document/:id', async (req: any, res: Response) => {
  try {
...
router.get('/status/:applicationId', async (req: any, res: Response) => {
  try {
