...
router.post('/admin/users/:userId/2fa', async (req: any, res: any) => {
  try {
...
// Update user role
router.post('/admin/users/:userId/role', async (req: any, res: any) => {
  try {
    const { userId } = req.params;
    const { role } = req.body;
...
router.post('/admin/users/:userId/permissions', async (req: any, res: any) => {
  try {
    const { userId } = req.params;
...
router.post('/admin/users/:userId/accounts', async (req: any, res: any) => {
  try {
    const { userId } = req.params;
