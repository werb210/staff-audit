...
import { processIncomingCall, IncomingCallData } from '../../services/partnerReferralService';
 ...
 */
router.post('/incoming-call', async (req: any, res: any) => {
 ...
 */
router.get('/incoming-call/test', async (req: any, res: any) => {
 ...
 */
router.get('/incoming-call/status', (req: any, res: any) => {
  res.json({
    success: true,
