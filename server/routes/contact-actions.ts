...
router.post('/calls/outbound', async (req: any, res: any) => {
  try {
...
router.post('/o365/mail/send', async (req: any, res: any) => {
  try {
...
router.post('/o365/events', async (req: any, res: any) => {
  try {
...
router.post('/o365/tasks', async (req: any, res: any) => {
  try {
...
router.post('/linkedin/messages', async (req: any, res: any) => {
  try {
...
async function logTimelineEvent(contactId: string, event: any) {
  try {
