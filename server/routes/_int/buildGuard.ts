...
const BUILD_TRACKING = {
  ...
  buildHashes: new Map<string, string>()
};
...
router.get('/verify-build', (req: any, res: any) => {
...
router.post('/emergency-build', async (req: any, res: any) => {
  const steps: string[] = [];
  ...
  try {
    ...
    await new Promise((resolve, reject) => {
      exec('cd /home/runner/workspace && rm -rf client/dist && npm run build', (error: any, stdout: any, stderr: any) => {
