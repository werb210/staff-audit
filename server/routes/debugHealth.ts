 ...
 */
router.get('/lender-products-health', async (req: any, res: any) => async (req: any, res: any) => {
  try {
 ...
 */
router.get('/database-safety-status', async (req: any, res: any) => async (req: any, res: any) => {
  try {
    const safetyChecks = {
