...
interface ApplicationAuditResult {
  applicationId: string;
  businessName: string;
  documentsInDB: number;
  filesOnDisk: number;
  missingFiles: number;
  accessibleDocuments: any[];
 ...
 */
export async function runFullDocumentAudit(): Promise<ApplicationAuditResult[]> {
  ...
  const auditResults: ApplicationAuditResult[] = [];
