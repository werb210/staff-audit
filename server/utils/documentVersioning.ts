 ...
 */
export async function storeDocumentWithVersioning(
 ...
 */
export async function reuploadDocumentWithVersioning(
  documentId: string,
  file: Express.Multer.File
): Promise<{ success: boolean; newStorageKey: string; hash: string }> {
 ...
 */
export async function createDocumentVersion(documentId: string, hash: string, storageKey: string): Promise<void> {
 ...
 */
export async function getDocumentVersionHistory(documentId: string): Promise<any[]> {
 ...
 */
export async function restoreDocumentVersion(documentId: string, versionHash: string): Promise<void> {
