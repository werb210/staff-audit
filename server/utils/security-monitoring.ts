...
export interface SecurityEvent {
  type: 'rate_limit' | 'invalid_input' | 'unauthorized_access' | 'sql_injection_attempt' | 'xss_attempt';
 ...
 */
export async function checkRequestAnomalies(ip: string, endpoint: string): Promise<boolean> {
  try {
