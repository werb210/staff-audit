...
export type SequenceLog = typeof sequenceLogs.$inferSelect;
export type RetargetingAudience = typeof retargetingAudiences.$inferSelect;
export type AttributionEvent = typeof attributionEvents.$inferSelect;
export type O365Token = typeof o365Tokens.$inferSelect;
export type O365CalendarEvent = typeof o365CalendarEvents.$inferSelect;
export type O365EmailThread = typeof o365EmailThreads.$inferSelect;
...
export type InsertSequenceLog = z.infer<typeof insertSequenceLogSchema>;
export type InsertRetargetingAudience = z.infer<typeof insertRetargetingAudienceSchema>;
export type InsertAttributionEvent = z.infer<typeof insertAttributionEventSchema>;
export type InsertO365Token = z.infer<typeof insertO365TokenSchema>;
export type InsertO365CalendarEvent = z.infer<typeof insertO365CalendarEventSchema>;
export type InsertO365EmailThread = z.infer<typeof insertO365EmailThreadSchema>;
...
export interface SequenceStep {
  id: string;
  type: 'email' | 'sms' | 'linkedin' | 'delay' | 'wait' | 'tag' | 'condition';
  name: string;
  config: {
    templateId?: string;
    subject?: string;
